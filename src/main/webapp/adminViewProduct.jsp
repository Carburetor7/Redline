                    ...
                    <div class="blog-card">
                        ...
                        <div class="card-content">
                            ...
                            <form method="post" action="" class="product-btn-form">
                                <button type="submit" formaction="./RemoveProductSrv?prodid=<%=product.getProdId()%>" class="btn add"><span class="span">Remove
                                        Product</span></button>

                                <button type="submit" formaction="updateProduct.jsp?prodid=<%=product.getProdId()%>" class="btn btn-blue buy"><span class="span">Update Product</span></button>
                            </form>
                        </div>
                    </div>
                </li>
